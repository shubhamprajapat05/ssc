...
const questions = [
    ...
    createQuestion(7, 'Question 7:', 'Select the most appropriate synonym of the given word: Erode.', ['A. Fix', 'B. Disintegrate', 'C. Preserve', 'D. Build'], 1),
    ...
    createQuestion(9, 'Question 9:', 'Select the most appropriate synonym of the given word: Thwart.', ['A. Impede', 'B. Aid', 'C. Support', 'D. Face'], 0),
    ...
    createQuestion(12, 'Question 12:', 'Select the most appropriate synonym of the given word: Scrap.', ['A. Hoard', 'B. Save', 'C. Store', 'D. Reject'], 3),
    ...
    createQuestion(14, 'Question 14:', 'Select the most appropriate synonym of the given word: Sane.', ['A. Sensible', 'B. Crazy', 'C. Sensitive', 'D. Foolish'], 0),
    ...
    createQuestion(16, 'Question 16:', 'Select the most appropriate synonym of the given word: Adversary.', ['A. Helper', 'B. Assistant', 'C. Rival', 'D. Supporter'], 2),
    createQuestion(17, 'Question 17:', 'Select the most appropriate synonym of the given word: Hind.', ['A. Front', 'B. First', 'C. Near', 'D. Rear'], 3),
    createQuestion(18, 'Question 18:', 'Select the most appropriate synonym of the given word: Fortify.', ['A. Harm', 'B. Secure', 'C. Neglect', 'D. Loosen'], 1),
